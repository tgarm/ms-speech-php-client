...
------------ | ------------- | ------------- | -------------
**word_error_rate2** | **double** | The word error rate of recognition with model2. | [optional] 
**word_error_rate1** | **double** | The word error rate of recognition with model1. | [optional] 
**sentence_error_rate2** | **double** | The sentence error rate of recognition with model2. | [optional] 
...
**sentence_error_rate1** | **double** | The sentence error rate of recognition with model1. | [optional] 
